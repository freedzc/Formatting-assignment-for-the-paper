...
\newtheorem{example}{\begin{CJK*}{GBK}{hei}例\end{CJK*}}
\newtheorem{definition}{\begin{CJK*}{GBK}{hei}定义\end{CJK*}}
\newtheorem{corollary}{\begin{CJK*}{GBK}{hei}推论\end{CJK*}}
\newtheorem{lemma}{\begin{CJK*}{GBK}{hei}引理\end{CJK*}}
...
%     \caption{Basic principle of DRL}
%     \label{fig.1}
% \end{figure}
